...
- `[ambassador_bank_form]` — выводит форму для ввода банковских реквизитов.
- `[ambassador_card_number]` — отображает последние 4 цифры номера банковской карты Амбассадора.
...
== Changelog ==
= 1.0.4 =
* Исправлено: отображение писем в яндекс почте.
...
* Добавлено: Шорткод отображения последних 4 цифр номера карты в личном кабинете Амбассадора `[ambassador_card_number]`.
...
== Upgrade Notice ==
= 1.0.4 =
* Обновите до версии 1.0.4 для правильного отображения писем в яндекс почте.
